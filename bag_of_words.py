...
if __name__ == '__main__':
    df_raw = pd.read_excel("Data/train/full_cleaned_v0.2.xlsx")
    ...
    print(df_bow.head())
    pickle.dump(count_vec_model, open("models/bag_of_words_v0.2.pickle", 'wb'))
    ...
    df_bow_train.to_csv('Data/train/bag_of_words_v0.2.csv', index=False)
    df_bow_test.to_csv('Data/test/bag_of_words_v0.2.csv', index=False)
