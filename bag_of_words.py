...
if __name__ == '__main__':
    df_raw = pd.read_excel("Data/train/full_cleaned_v0.3.xlsx")
    ...
    df_bow_train.to_csv('Data/train/bag_of_words_v0.3.csv', index=False)
    df_bow_test.to_csv('Data/test/bag_of_words_v0.3.csv', index=False)
