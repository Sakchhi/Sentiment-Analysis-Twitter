...
if __name__ == '__main__':
    df_raw = pd.read_excel("Data/processed/train/preprocess/full_cleaned_v0.5.xlsx")
    ...
    print(df_bow.head())
    pickle.dump(count_vec_model, open("models/feature_eng_model/bag_of_words_v0.5.pickle", 'wb'))
    ...
    df_bow_train.to_csv('Data/processed/train/feature_eng/bag_of_words_v0.5.csv', index=False)
    df_bow_test.to_csv('Data/processed/test/feature_eng/bag_of_words_v0.5.csv', index=False)
